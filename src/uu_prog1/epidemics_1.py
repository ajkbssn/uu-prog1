...
def SIR(S0, I0, R0, a, b, T=100):
    ...
    Takes initial susceptibles, infected, recovered,
    the rate of a susceptible becoming infected,
    the recovery rate, and optionally how many periods
    the simulation shall run.
    Returns four time series numpy arrays
    (susceptibles, infected, recovered, and time)
    """
